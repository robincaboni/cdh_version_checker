...
(function () {
  ...
  */
        //https://my.tealiumiq.com/urest/datacloud/ACCOUNT/PROFILE/profile/version/name?utk=UTK
        getVersionNames: function (profile) {
            return new Promise(function (resolve, reject) {
                ...
                xhr.open("GET", "https://my.tealiumiq.com/urest/datacloud/" + window.tt_udh_ver.account() + "/" + profile + "/profile/version/name?utk=" + window.tt_udh_ver.utk + "&_=" + window.tt_udh_ver.random() + "&cb=" + window.tt_udh_ver.random(), true);
                xhr.send();
            });
        },
        // https://my.tealiumiq.com/urest/datacloud/ACCOUNT/PROFILE/profile/revision?utk=UTTK&versions=2019-03-28+Tealium+Cleanup&versions=2019-04-08+Android+Pit+Removal&start=2019-03-16T00%3A00%3A00.000Z
        // expects a string
        getRevisions: function (profile) {
            return new Promise(function (resolve, reject) {
                var xhr = new XMLHttpRequest();
                xhr.addEventListener("load", function () {
                    if (xhr.status == 404)
                ...
                xhr.open("GET", "https://my.tealiumiq.com/urest/datacloud/" + window.tt_udh_ver.account() + "/" + profile + "/profile/revision?utk=" + window.tt_udh_ver.utk + "&_=" + window.tt_udh_ver.random() + "&cb=" + window.tt_udh_ver.random(), true);
                xhr.send();
            });
        },
